...
const managerNav: NavItem[] = [
  ...
  { label: "Performance", href: "/dashboard/performance", icon: <Icon d="M18 20V10M12 20V4M6 20v-6" /> },
  { label: "Follow-ups", href: "/dashboard/followups", icon: <Icon d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" /> },
